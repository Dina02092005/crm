...
export function CreateCounsellorSheet({ onCounsellorCreated }: { onCounsellorCreated: () => void }) {
        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="w-full sm:max-w-xl flex flex-col p-0">
                <div className="p-6 pb-2">
                    <SheetHeader>
                        <SheetTitle>Add New Counsellor</SheetTitle>
                        <SheetDescription>
                            Create a new counsellor account in the system.
                        </SheetDescription>
                    </SheetHeader>
                </div>
