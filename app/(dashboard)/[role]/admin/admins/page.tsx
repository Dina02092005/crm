...
export default function AdminsManagementPage() {
    ...
    // Query Hook - Strictly filter for ADMIN
    const { data, isLoading, refetch } = useEmployees(statusFilter, page, limit, "ADMIN", debouncedSearch);
    ...
    const { data: employeeStats } = useEmployeeStats("ADMIN");
            ...
            <div className="p-10">
                <Card className="border-0 rounded-3xl">
                    <CardContent className="p-16 text-center">
                        ...
                        <p className="text-slate-500 mt-2">Only Super Admins can manage administrator accounts.</p>
                    </CardContent>
                </Card>
            </div>
        );
    ...
    return (
        <div className="flex flex-col gap-2 p-3 sm:p-4">
            <div className="flex flex-col gap-1 mb-6 px-1">
                 <h1 className="text-2xl font-black tracking-tight text-gray-900 uppercase">Manage Administrators</h1>
                 <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Create and control system-wide administrative accounts</p>
            </div>
            ...
            <Card className="border-0 rounded-3xl overflow-hidden bg-card shadow-sm border-gray-100">
                <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                        {[
                            { id: "all", label: "Total Admins", color: "text-blue-600", bg: "bg-blue-50" },
                    ...
                    {isLoading ? (
                        <div className="py-20 flex flex-col items-center justify-center gap-3">
                            ...
                            <p className="text-sm text-gray-500 font-medium">Loading administrators...</p>
                        </div>
                    ) : (
                        <EmployeesTable
                            data={employees}
            ...
            <ConfirmDialog
                ...
                description="Are you sure you want to delete this administrator account? This action cannot be undone."
                confirmText="Delete"
                variant="destructive"
            />
            ...
            <ConfirmDialog
                ...
                title={currentStatus ? "Deactivate Admin" : "Activate Admin"}
                description={
                    currentStatus
                        ? "Are you sure you want to deactivate this admin? They will no longer be able to log in to the administrative portal."
