...
export default function CoursesPage() {
    ...
    const handleManageIntake = (course: any) => {
        setSelectedCourse(course);
                    ...
                    {can("MASTERS", "CREATE") && (
                        <>
                            ...
                            <Button
                                ...
                                onClick={() => { setSelectedCourse(null); setIsAddOpen(true); }}
                            >
                ...
                <div className="flex-1 overflow-x-auto">
                    <Table className="min-w-[1500px] border-collapse">
                        ...
                        <TableBody>
                            {isLoading ? (
                                <TableRow>
                                    <TableCell colSpan={15} className="h-32 text-center text-gray-500 italic font-medium">
                                    ...
                                    <TableRow key={course.id} className="hover:bg-gray-50/50 border-b border-gray-100 items-start">
                                        ...
                                        <TableCell className="border-r border-gray-100 p-2">
                                            <div className="flex flex-col items-center gap-1.5">
                                                <Button
                                                    className="h-8 w-full bg-[#1e293b] hover:bg-[#334155] rounded-none text-[11px] gap-1.5 px-3 uppercase tracking-wider font-bold shadow-sm"
                                                    onClick={() => handleManageIntake(course)}
                                                >
                                        ...
                                        <TableCell className="border-r border-gray-100 text-xs text-gray-500 max-h-20 overflow-hidden line-clamp-3 italic leading-snug">
